    ...
    <div class="home">
        ...
        <div class="carousel-section">
            ...
            <div class="carousel-container">
                ...
                <div class="carousel-wrapper">
                    <div class="carousel-track" :style="{ transform: `translateX(-${currentSlide * 100}%)` }">
                        <div v-for="(book, index) in displayedBooks" :key="book._id" class="carousel-item"
                            :class="{ 'active': index === currentSlide }">
                            <div class="book-card">
                                <div class="book-cover">
                                    <img :src="book.coverUrl || getDefaultCover(book.title)" :alt="book.title"
                ...
                <button class="carousel-control next" @click="nextSlide" :disabled="currentSlide >= maxSlides - 1"
            ...
            <div class="carousel-indicators">
                <button v-for="(_, index) in displayedBooks" :key="index" class="indicator"
...
export default {
  ...
  <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
    <rect width="100%" height="100%" fill="${backgroundColor}"/>
    <text x="50%" y="50%" font-family="Georgia, serif" font-size="36" fill="white" text-anchor="middle" dominant-baseline="middle" font-weight="bold">${initials}</text>
  </svg>
`;
            return 'data:image/svg+xml;base64,' + btoa(unescape(encodeURIComponent(svg)));
        },
...
@media (max-width: 768px) {
    ...
    .book-overlay {
        transform: translateY(0);
        background: linear-gradient(to top, rgba(26, 35, 126, 0.9), rgba(26, 35, 126, 0.3), transparent);
        padding: 1rem;
    }
